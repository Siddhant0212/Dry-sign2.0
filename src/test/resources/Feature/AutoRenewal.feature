...
Feature: To Verify Auto Renewal (Recurrsive) functionality
     ...
     @AutoRenewal1
  Scenario: To verify functionality of Auto Renewal with scheduler
     Given navigate to URL "https://drysign-dev.exela.global/#/login"
    When enter the user name as "sidDB@mailinator.com"
    When enter the password as"Malin@555"
    And user click on the Login button
    Then user has last day of existing plan
    Then user navigate to the Email as "https://www.mailinator.com/v4/public/inboxes.jsp"
  
    @AutoRenewal2
  Scenario: To verify functionality of Auto Renewal if scheduler fails to renew plan
    Given navigate to URL "https://drysign-dev.exela.global/#/login"
    When enter the user name as "sidDB@mailinator.com"
    When enter the password as"Malin@555"
    And user click on the Login button
