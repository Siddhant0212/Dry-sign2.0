...
public class DrySignObjects {
	...
	public static WebElement Signature_drpOption(String data)
	{
		String Xpath = "//div[contains(@id,'PSPDFKit-dd-signature')]//div[contains(text(),'$')]";
		WebElement element = Base.driver.findElement(By.xpath(Xpath.replace("$", data)));
		return element;
	}
	
	public static WebElement fullname_drpOption(String data)
	{
		String Xpath = "//div[contains(@id,'PSPDFKit-dd-fullName')]//div[contains(text(),'$')]";
		WebElement element = Base.driver.findElement(By.xpath(Xpath.replace("$", data)));
		return element;
	}
			...
			public static WebElement priority_num(String data)
			{
				String Xpath = "(//div[contains(@class,'priority-serial')])[$]";
				WebElement element = Base.driver.findElement(By.xpath(Xpath.replace("$", data)));
				return element;
			}
			
			public static WebElement signature_delete(String data)
			{
				String Xpath = "(//i[contains(@class,'delete')])[$]";
				WebElement element = Base.driver.findElement(By.xpath(Xpath.replace("$", data)));
				return element;
			}
			
			public static WebElement Remove_Signature(String data)
			{
				String Xpath = "//span[contains(text(),'$')]//parent::td[@data-title='Email Id']//following-sibling::td[2]//a[@mattooltip='Remove']/img";
				WebElement element = Base.driver.findElement(By.xpath(Xpath.replace("$", data)));
				return element;
			}
