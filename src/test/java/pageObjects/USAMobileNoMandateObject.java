...
public class USAMobileNoMandateObject {
	
	public USAMobileNoMandateObject (WebDriver driver)
	{
...
//TS1	
	...
	@FindBy(xpath="(//div[@class='px-4 mt-3 ng-star-inserted'])[2]")
	public static WebElement Days_Text;
	
	@FindBy(xpath="//div[@class='mat-ripple mat-tab-header-pagination mat-tab-header-pagination-after mat-elevation-z4']")
	...
	public static WebElement personalProfile(String data)
	{
	String Xpath = "//label[@id='$']";
	WebElement element = Base.driver.findElement(By.xpath(Xpath.replace("$", data)));
	return element;
	}
	
	public static WebElement PasswordField(String data)
	{
	...
	public static WebElement enterOTP(String string)
	{
	String xpath = "//ng-otp-input[1]//input[$]";
	...
	@FindBy(xpath="(//span[@class='exela-icon-logout fs-24'])[1]")
	public static  WebElement clickLogOut;
	
	@FindBy(xpath="//i[@class='exela-icon-close']")
	public static  WebElement exelaIconClose;
	...
	public static List<WebElement> btnViewPlan1;
  ...
  //span[text()='Confirm']
    ...
    @FindBy(xpath="//p[text()='Your subscription is cancelled successfully. You can enjoy free version.']")
    public static WebElement Yoursubscriptioniscancelledsuccessfully;
  ...
  //p[@class='text strong ng-star-inserted']
	...
	@FindBy(xpath="//button[text()='Send One Time Password']")     
...
//	}
	...
	{
		WebElement element = Base.driver.findElement(By.xpath("//label[text()='Confirm Secure Code']/following-sibling::ng-otp-input//input[$]".replace("$", string)));
...
//MYFILES
	...
	@FindBy(xpath="//pdf-viewer[@class='mt-5 ng-star-inserted']")     
	...
	@FindBy(xpath="//div[@class='pdf-container pspdfkit-container']")     
	...
	@FindBy(xpath="//a[@mattooltip='Mail']")     
	...
	@FindBy(xpath="//p[text()='Successfully Mail Sent']")     
